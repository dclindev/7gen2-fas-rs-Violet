...
function load_fas(pid, pkg)
    ...
    elseif (pkg == "com.miHoYo.Nap" or pkg == "com.miHoYo.Nap.bilibili" or pkg == "com.miHoYo.hkrpg" or pkg == "com.miHoYo.hkrpg.bilibili")
    then
        set_ignore_policy(0, true)
        set_extra_policy_abs(7, 2000000, 2650000) 
        set_extra_policy_rel(4, 7, -200000, 0)
